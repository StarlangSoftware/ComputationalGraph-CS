...
namespace ComputationalGraph.Initialization
{
    ...
    {
        /**
         * <summary>Initializes weights using He uniform initialization.</summary>
         *
        ...
        public List<double> Initialize(int row, int column, Random random)
        {
            ...
            for (var i = 0; i < row; i++)
            {
                ...
                {
                    data.Add(
                        ((System.Math.Sqrt(6.0 / column) + System.Math.Sqrt(6.0 / row)) * random.NextDouble())
                        - System.Math.Sqrt(6.0 / row)
                    );
                }
            }
